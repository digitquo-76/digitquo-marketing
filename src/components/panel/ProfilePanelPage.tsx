...
export function ProfilePanelPage() {
      ...
      <DashboardShell
        ...
        actions={(
          <div className="topbar-actions">
            <Link className="btn-panel btn-panel-secondary" href={routeForRole(role)}>Back to dashboard</Link>
      ...
      >
        ...
        <section className="panel-card">
          <header className="panel-card-header">
            <div>
              <h2 className="panel-card-title">Profile information</h2>
              <p className="panel-card-subtitle">Signed in as {store.profile.email}</p>
            </div>
          </header>
          <form className="panel-card-body" onSubmit={saveProfile}>
            ...
            {role !== 'admin' && (
              <button className="btn-panel btn-panel-primary" type="submit" style={{ marginTop: '18px' }}>
